...
def run_automatic_base_sequence():
    ...
    try:
        ...
        logger.info("AUTOMATIC MODE: Advancing again for 6 seconds...")
        move_robot_base("forward", True, auto_speed); time.sleep(6)
        move_robot_base("forward", False, auto_speed); logger.info("AUTOMATIC MODE: Stopped after second advance.")
        logger.info("AUTOMATIC MODE: Returning to start (moving backward for 12s)...")
        move_robot_base("backward", True, auto_speed); time.sleep(12)
